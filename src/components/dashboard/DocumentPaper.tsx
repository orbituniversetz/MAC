  ...
  return (
    <div id="document-paper" className={cn("a4-page font-sans", className)}>
        ...
        <div className="flex items-center">
          {settings.garage_logo ? (
            ...
            <div className="h-20 w-20 bg-zinc-50 rounded-lg flex items-center justify-center text-zinc-200">
              {doc.docType === 'LETTER' ? <Mail className="h-10 w-10" /> : <FileText className="h-10 w-10" />}
            </div>
          )}
        </div>
      ...
      <div className="mb-12 space-y-8 avoid-break">
        ...
        {doc.vehiclePlate && (
          <div className="bg-zinc-50 p-5 rounded-2xl border border-zinc-100 inline-block min-w-[400px]">
