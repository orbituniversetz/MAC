...
export function InvoiceDocument({ invoice, settings, className }: InvoiceDocumentProps) {
  ...
  return (
    <div id="invoice-document" className={cn("bg-zinc-800 p-1 shadow-2xl rounded-sm", className)}>
      <div className="a4-page text-black font-sans bg-white mx-auto">
        ...
        <div className="flex justify-between items-center mb-8 bg-zinc-950 text-white p-4 rounded-md shadow-lg">
        ...
        <div className="grid grid-cols-2 gap-12 mb-10">
          ...
          <div className="bg-zinc-50 p-5 rounded-2xl border-2 border-zinc-100 flex flex-col justify-center">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="pt-2 border-t-2 border-zinc-200 mt-2 font-black text-zinc-500 text-[10px] uppercase tracking-widest">
        ...
        <table className="w-full mb-10 border-collapse">
          ...
          <tbody className="divide-y-2 divide-zinc-100 font-bold">
            {snapshot.items?.map((item: any, index: number) => (
              <tr key={item.id} className="text-xs group hover:bg-zinc-50">
                <td className="p-4 text-center text-zinc-400">{index + 1}</td>
        ...
        <div className="flex justify-end mb-12">
          <div className="w-72 space-y-2 bg-zinc-50 p-6 rounded-3xl border-2 border-zinc-100 shadow-lg">
        ...
        <div className="mt-auto pt-10 border-t-4 border-zinc-950">
          <div className="grid grid-cols-2 gap-12">
            ...
            <div className="text-right signature-block flex flex-col justify-end">
              <p className="text-[10px] font-black mb-6 uppercase tracking-widest text-zinc-400">Authorized Signature & Seal</p>
              <div className="h-16 border-b-4 border-zinc-900 w-56 ml-auto mb-2 opacity-20"></div>
