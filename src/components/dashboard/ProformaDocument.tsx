      ...
      <div className="flex justify-between items-center mb-8 bg-zinc-950 text-white p-4 rounded shadow-sm shrink-0 avoid-break text-left">
        <div>
          ...
          <p className="text-[10px] font-bold text-zinc-300 mt-0.5">
            Date Issued: {proforma.createdAt ? new Date(proforma.createdAt).toLocaleDateString() : new Date().toLocaleDateString()}
          </p>
        </div>
      ...
      <div className="space-y-6">
        ...
        <div className="p-6 rounded-2xl flex justify-between items-center border-2 bg-zinc-950 text-white shadow-md">
          <div>
            ...
            <h4 className="text-xl font-black tracking-tight">{isFullyPaid ? 'FULLY SETTLED' : totalPaid > 0 ? 'PARTIALLY PAID' : 'PENDING PAYMENT'}</h4>
          </div>
          <div className="text-right">
